...
class NodeInstanceDB
{
	...
	static const int DEPOT_CLOSENESS = 25;
...
public:
	...
	static NodeInstanceDB * createCloseToDepotInstance(int nCustomers, int nPeriods, int version);
	static NodeInstanceDB * createClusterInstance(int nCustomers, int nPeriods, int version);
